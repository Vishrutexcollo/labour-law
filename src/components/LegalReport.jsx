    ...
    return (
        <div className="report-container fade-in">
            ...
            <div className="report-body">
                {/* Build sections array — only sections with content are included */}
                {(() => {
                    const sections = [];

                    if (hasContent(at_a_glance)) {
                        sections.push({
                            title: "AT-A-GLANCE STATUS", render: (id) => (
                                <ReportSection key={id} id={id} title="AT-A-GLANCE STATUS">
                                    <ReportTable
                    ...
                    if (hasContent(executive_summary || answer)) {
                        sections.push({
                            title: "EXECUTIVE SUMMARY", render: (id) => (
                                <ReportSection key={id} id={id} title="EXECUTIVE SUMMARY">
                    ...
                    if (hasContent(applicability_detail)) {
                        sections.push({
                            title: "APPLICABILITY DETERMINATION", render: (id) => (
                                <ReportSection key={id} id={id} title="APPLICABILITY DETERMINATION">
                    ...
                    if (hasContent(checklist)) {
                        sections.push({
                            title: "COMPLIANCE CHECKLIST", render: (id) => (
                                <ReportSection key={id} id={id} title="COMPLIANCE CHECKLIST">
                                    <ReportTable
                    ...
                    if (hasContent(risks)) {
                        sections.push({
                            title: "RISKS & GREY AREAS", render: (id) => (
                                <ReportSection key={id} id={id} title="RISKS & GREY AREAS">
                                    {risks.map((risk, i) => (
                    ...
                    if (hasContent(penalties)) {
                        sections.push({
                            title: "PENALTY EXPOSURE", render: (id) => (
                                <ReportSection key={id} id={id} title="PENALTY EXPOSURE">
                                    <ReportTable
                    ...
                    if (hasContent(next_steps)) {
                        sections.push({
                            title: "NEXT STEPS", render: (id) => (
                                <ReportSection key={id} id={id} title="NEXT STEPS">
                                    <ReportTable
                    ...
                    if (hasContent(bare_act || citations)) {
                        sections.push({
                            title: "EVIDENCE INDEX", render: (id) => (
                                <ReportSection key={id} id={id} title="EVIDENCE INDEX">
                                    {hasContent(bare_act) && (
                    ...
                    // Render all sections with continuous numbering
                    return sections.map((section, index) => section.render(String(index + 1)));
                })()}
